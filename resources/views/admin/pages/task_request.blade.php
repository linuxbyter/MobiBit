                                    ...
                                    @foreach($tasks as $key => $row)
                                        ...
                                        @if($user && $task)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.task.request.status', [$row->id,'approved'])}}" class="btn btn-success">Approved</a>
                                                    <a href="{{route('admin.task.request.status', [$row->id,'rejected'])}}" class="btn btn-danger">Rejected</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
